...
import GET_USERS from "../../../graphql/query/users.gql";
...
//       query: GET_USERS,
//       variables: {
//         limit: useUserStore.$state.limit,
//         offset: useUserStore.$state.offset,
//       },
//     },
//   ],
//   clientId: "user",
                ...
                <span
                  :class="
                    user.is_email_verified
                      ? 'text-green-500 bg-green-100 px-4 py-1 rounded-lg text-x '
                      : 'text-red-500 bg-red-100  px-4 py-1 rounded-lg text-x'
                  "
                >
